...
var cn = {
    ...
    // #abstract
    abstract_item1: '简介',
    abstract_item2: 'e<span>G</span>aming<span>F</span>und的目标是建设一个<span>民有</span>、<span>民治</span>、<span>民享</span>的区块链游戏内容公共社区，用户可以做游戏、玩游戏、交流游戏、进行数字财产确权及交易。社区通过智能合约去中心化共识方式UGC（User Generate Content），进行贡献定价和权益回报，使内容生产者、内容筛择评论者、社区推广者、玩家都能得到合理的激励，促使社区长期良性发展及壮大。目前e<span>G</span>aming<span>F</span>und已拥有自己的游戏制作工具“BCreator.io”（已完成内部测试版本）。',
    ...
    total_content_item1: 'GFG是本社区通证，拥有GFG是社区成员的标志。GFG总量50亿个，可精确到10<sup>-8</sup>，永不增发。',
    // (Game Fundation Gold)
...
var en = {
    ...
    team_text_item3: 'Oliver is the producer behind the MUD classic 3Kindgoms and the MMO game Warhammer: End Times - Vermintide. Mr. Wu previously ran the Singapore Interactive Media Center, as well as the heading Development and Operations of the virtual reality world of the Youth Olympic Games. He has also been the overseas President of Zhongqingbao.',
